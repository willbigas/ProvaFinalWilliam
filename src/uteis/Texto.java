...
public class Texto {
    ...
    // Mensagens de regra de negocio
    public static final String DESTINO_VAZIO = "O Campo Destino está vazio";
    public static final String DESTINO_OBRIGATORIO = "O Campo Destino é Obrigatório";
    
    
    public static final String KM_FINAL_VAZIO = "O Campo KmFinal está vazio";
